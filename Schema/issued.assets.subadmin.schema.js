...
const issuedAssetsToSubAdminSchema = new mongoose.Schema(
  {
...
const IssuedAssetsToSubAdminModel = mongoose.model(
  "Issued-Assets-To-Sub-Admin",
  issuedAssetsToSubAdminSchema
);
export default IssuedAssetsToSubAdminModel;
